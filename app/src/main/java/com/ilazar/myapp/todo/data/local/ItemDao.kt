...
interface ItemDao {
    ...
    @Query("SELECT * FROM Items WHERE _id LIKE 'offline' ")
    fun getAllAddedOffline() : Flow<List<Item>>

    @Query("DELETE FROM Items WHERE _id LIKE 'offline' ")
    fun deleteOfflineAddedItems():Unit
